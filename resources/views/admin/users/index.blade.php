<x-layouts.admin :title="'Users'">
    <div class="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        ...
        <a href="{{ route('admin.users.create') }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm shadow-indigo-600/20 transition hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/30">
                        ...
                        <tr class="align-middle transition hover:bg-slate-50/70 dark:hover:bg-slate-950/60">
                            ...
                            <td class="whitespace-nowrap px-5 py-4 text-right sm:px-6">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('admin.users.edit', $user) }}" class="rounded-lg px-2.5 py-1.5 text-xs font-semibold text-indigo-600 hover:bg-indigo-50 dark:text-indigo-300 dark:hover:bg-indigo-500/10">Edit</a>
